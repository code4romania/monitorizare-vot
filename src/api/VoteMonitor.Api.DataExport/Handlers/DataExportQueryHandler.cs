...
namespace VoteMonitor.Api.DataExport.Handlers
{
         ...
         IRequestHandler<GetNotesForExport, IEnumerable<NotesExportModel>>
    {
        ...
        public Task<IEnumerable<NotesExportModel>> Handle(GetNotesForExport request, CancellationToken cancellationToken)
        {
            ...
            FROM public.""Notes"" n
            INNER JOIN public.""Observers"" obs ON n.""IdObserver"" = obs.""Id""
            LEFT JOIN public.""NotesAttachments"" na ON na.""NoteId"" = n.""Id""
            INNER JOIN public.""PollingStations"" ps ON n.""IdPollingStation"" = ps.""Id""
            INNER JOIN public.""Counties"" cc ON ps.""IdCounty"" = cc.""Id""
            WHERE obs.""IsTestObserver"" = false
            ...
            FROM public.""Notes"" n
            INNER JOIN public.""Observers"" obs ON n.""IdObserver"" = obs.""Id""
            INNER JOIN public.""Questions"" q ON n.""IdQuestion"" = q.""Id""
            INNER JOIN public.""OptionsToQuestions"" oq ON oq.""IdQuestion"" = q.""Id""
            INNER JOIN public.""Options"" o ON oq.""IdOption"" = o.""Id""
            INNER JOIN public.""FormSections"" fs ON q.""IdSection"" = fs.""Id""
            INNER JOIN public.""Forms"" f ON fs.""IdForm"" = f.""Id""
            INNER JOIN public.""Answers"" a ON a.""IdOptionToQuestion"" = oq.""Id""
            ...
            WHERE NOT EXISTS
                (SELECT *
                 ...
                 INNER JOIN public.""OptionsToQuestions"" oq ON oq.""Id"" = a.""IdOptionToQuestion""
