...
using VoteMonitor.Api.Core.AuthorizationRequirements;
...
namespace VoteMonitor.Api.Extensions
{
    public static class JwtConfigurationExtensions
    {
            ...
            IConfiguration configuration)
        {
            ...
            services.AddSingleton<IAuthorizationHandler, IsNonBannedAuthorizationHandler>();

            services.AddAuthorization(options =>
            {
                options.AddPolicy("NgoAdmin", policy => policy.RequireClaim(ClaimsHelper.UserType, UserType.NgoAdmin.ToString()).AddRequirements(new IsNonBannedAdminRequirement()));
